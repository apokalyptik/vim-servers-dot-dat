...
syntax match sddHostDomain "\v\.?[^.]+\.[^.:]+:" contains=sddFieldDelim
...
syntax match sddHOSTNAME   /.\{-}\(:\|$\)/ nextgroup=sddLAN      contains=sddFieldDelim,sddHostDomain
...
highlight sddHostDomain ctermfg='lightyellow'   guifg='lightyellow'
